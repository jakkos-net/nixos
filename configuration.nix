{pkgs-stable, pkgs-unstable, ...}: {
  ...
  home-manager.users.jak = {  # home-manager is used for user-level configuration, e.g. dotfiles
    ...
    xdg.desktopEntries = { # app launcher shortcuts
      ...
      re = {name="re"; exec="firefox --url https://youtube.com --url https://reddit.com --url https://reddit.com/r/all --url https://news.ycombinator.com --url https://lobste.rs --url https://bsky.app --url https://twitter.com";};
